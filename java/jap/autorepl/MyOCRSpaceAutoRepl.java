...
public class MyOCRSpaceAutoRepl implements MyAutoReplacement
{
	...
	private Map< String, String > readToTreeMap()
	{
		...
		mlts.writeMess( "Read auto replaces file for OCR Space: \"" + MyParams.getStringValue( "autorepl_ocrspace_path" ) + "\"..." );
		...
		for( String s_pos : mtfr.readFileAsStringAL( MyParams.getStringValue( "autorepl_ocrspace_path" ) ) )
		{
	...
	public void saveToFile() { this.saveToFile( MyParams.getStringValue( "autorepl_ocrspace_path" ) ); }

...
public class MyJapToEnTranslateWin extends JFrame
{
	public MyJapToEnTranslateWin( String s_text )
	{
		MyTranslateShell mts = new MyTranslateShell();
		String s_transl = mts.translateJapToEng( s_text );
	...
	private JPanel makePanelWithWord( String s_text )
	{
		...
		Border b_transl_border = BorderFactory.createTitledBorder( "Japan word" );
	...
	{
		JPanel res_panel = new JPanel( new BorderLayout() );
		Border b_transl_border = BorderFactory.createTitledBorder( "English translation" );
		res_panel.setBorder( b_transl_border );
